            ...
            @foreach ($data['incidencias'] as $incidencia)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/incidence/edit/{{ $incidencia['id_incidencia'] }}" style="border-radius: 13px"
                            class="btn btn-warning" title="Editar incidencia">
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-center">
                        ...
                        <p class="text-secondary">Puedes crear una nueva incidencia dándole a la opción <b>Crear Incidencia</b> en el menú de la izquierda.</p>
                    </div>
                </div>
            </div>
        @endif

...
@section('content')
    ...
    <section id="titulo" class="content-header">
        <div class="container-fluid">
            <div class="row mb-12">
                <div class="col-sm-12">
                    <h1 style="text-align: center">Cambiar datos del usuario</h1>
            ...
            <form action="/user/edit/{{$user['id']}}" method="POST">
                ...
                <div class="card">
                    <div class="card-header dark-header align-middle">
                        <h3 class="card-title mt-2">Información del usuario</h3>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <select id="validado" class="form-control select2" name="validated" onchange="Filter(event)">
                                        <option value="true" @if ($user['validated'] == 'true') selected @endif>Sí</option>
                                        <option value="false" @if ($user['validated'] == 'false') selected @endif>No</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <label for="rol">Rol</label>
                                    <select id="rol" class="form-control select2" name="rol" onchange="Filter(event)">
                                        <option value="admin" @if ($user['rol'] == 'admin') selected @endif>
                                            Administrador</option>
                                        <option value="user" @if ($user['rol'] == 'user') selected @endif>Usuario
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    <label for="notify_email">¿Puede recibir correos?</label>

...
@section('content')
    ...
    <section id="titulo" class="content-header">
        <div class="container-fluid">
            <div class="row mb-12">
                <div class="col-sm-12">
                    <h1 style="text-align: center">Cambiar datos de la Aula</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div id="formularioIncidencia" class="row md-2">
        ...
        <div class="col-md-10">
            ...
            <form action="/aula/edit/{{$aula['id']}}" method="post">
                @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group text-center">
                            ...
                            <input type="text" class="form-control" name="aula" id="InputAula"
                                placeholder="Introduce el nombre de la aula" value="{{$aula['aula']}}" required>
                        </div>
                    </div>
                    <!-- /.card-body -->
                </div>

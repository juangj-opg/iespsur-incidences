...
<body>
    <div style="width:500px; border-radius: 10px;">
        <div class="dark-header" style="width: 100%; height:100%; padding: 5px; border-radius: 10px;">
            <h3 style="text-align: center; padding-top: 5px;">¡Se ha añadido un nuevo comentario en tu incidencia!</h3>
        </div>

        <h3 style="text-align: center; margin-top: 10px;">{{$info[2]['title']}}</h3>
        <hr>
